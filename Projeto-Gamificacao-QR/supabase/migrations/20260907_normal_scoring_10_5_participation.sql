-- Regras finais de pontuação das atividades normais.
-- Verdadeiro/Falso: 1 tentativa; 10 pontos se acertar, 1 ponto por participação se errar.
-- Demais tipos: até 2 tentativas; 10 pontos na 1ª, 5 na 2ª; 1 ponto por participação se errar as duas.
...
begin
    ...
    if v_correct then
        v_points := case v_attempt when 1 then 10 when 2 then 5 else 0 end;
